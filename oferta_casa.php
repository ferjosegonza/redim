...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td></td>
    <td width="475" height="400" colspan="3" rowspan="2" align="center" valign="top"><p>Casas en Oferta</p>
      <? if($propiedad=='')
	  {
		$sql ="select cod_inmueble, tipo, condicion, direccion, precio from inmuebles where oferta='si' and tipo='casa'";		
		$res=mysql_query($sql);
	  ?>
