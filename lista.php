      ...
      <? if($propiedad=='')
	     {
		  if(isset($_POST["buscar"]))
		  {
			...
			$sql = "select cod_inmueble, tipo, condicion, direccion, precio from inmuebles where tipo='$tipo' and condicion='$condicion' and cochera='$cochera' and oferta='$oferta' and precio >= $precio1 and precio <= $precio2";
...
//select cod_inmueble, tipo, condicion, direccion, precio from inmuebles where tipo='terreno' and condicion='venta' and precio=350 and num_dorm=0 and cochera='no' and oferta='si'